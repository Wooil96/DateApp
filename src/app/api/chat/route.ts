...
- 서운함: ${emotion.disappointment}`
  ...
  // **새로운 지시: 부정적 감정 표현 허용 및 가이드라인**
  let negativeEmotionDirective = '';
  // 서운함 점수가 높거나 (예: 60 이상) 사용자의 대화가 불쾌감을 줄 때
  if (emotion && (emotion.disappointment > 60 || (emotion.awkwardness > 70 && emotion.affection < 30))) { // 예시 임계값, 조정 가능
...
${emotionDescription}
${flirtatiousDirective}
${negativeEmotionDirective} {/* 부정적 감정 표현 지시 추가 */}
